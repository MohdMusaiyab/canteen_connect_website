  ...
  return (
    <div className="p-4">
      <p className="text-gray-700 text-lg leading-relaxed">
        ...
        app ensures you can browse, order, and pick up your favorite dishes with
        ease. It's all about convenience, reducing wait times, and ensuring you
        never miss a meal due to long queues.
      </p>
    </div>
  );
};
